...
function cmfe_admin_enqueue_scripts( $hook ) {
	...
	wp_register_style( 'codemirror', plugins_url( 'codemirror/lib/codemirror.css', __FILE__ ), null, '5.16.0' );
	wp_register_style( 'cmfe', plugins_url( 'plugin.css', __FILE__ ), array( 'codemirror' ), '1.2.0' );

	wp_enqueue_style( 'cmfe' );

	wp_register_script( 'requirejs', plugins_url( "require$suffix.js", __FILE__ ), null, '2.2.0', true );
